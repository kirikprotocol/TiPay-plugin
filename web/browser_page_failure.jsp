...
<%!
  ...
  private static final Pattern URI_PATTERN = Pattern.compile(".*/failure/([0-9a-zA-Z]+)");
%>
<%
...
<table>
  ...
  <tr>
    <td><b>Результат:</b></td>
    <td><font color="red">Отказ в проведении платежа</font></td>
  </tr>
</table>
</body>
</html>
